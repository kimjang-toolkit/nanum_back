...
import { CoBuyingDetail, CoBuyingSummary } from "@interface/cobuying";
/**
...
export interface DBAdapterQueryInterface {
  ...
  queryCoBuyingSummaryByOwnerNameAndId(ownerName: string, id: string): Promise<CoBuyingSummary>;
  queryCoBuyingDetailByOwnerNameAndId(ownerName: string, id: string): Promise<CoBuyingDetail>;
}